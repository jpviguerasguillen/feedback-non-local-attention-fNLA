...
def denseUnet(blocks, input_shape, growth_rate, drop_rate, classes, weights=None, 
    ...
    # ---
    x22 = layers.Concatenate(name='conc22')([x21T,x31U])
    ...
    # ======================================================================== 
    # --- FIFTH DIAGONAL ----------------------------------------------------
    x04 = layers.Concatenate(name='conc04')([x03T,x13U])
    ...
    model = Model(inputs=xi0, outputs=x05, name='denseUnetPlus')
