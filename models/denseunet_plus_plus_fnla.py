...
def denseUnet(blocks, input_shape, growth_rate, drop_rate, classes, weights=None, 
    ...
    x12 = attention_NLA(x12, x12.shape[-1]//8, x22, type_att='mul', name='attn12')
    x12T = transition_block(x12, tran_channels[1], name='tran12')
    x12U = upsampling_block(x12, tran_channels[1], growth_rate, name='upsa12')
    
    x02 = attention_NLA(x02, x02.shape[-1]//8, x12, type_att='mul', name='attn02')
    ...
    x03 = attention_NLA(x03, x03.shape[-1]//8, x13, type_att='mul', name='attn03')
    ...
    model = Model(inputs=xi0, outputs=x05, name='denseUnetPlusPlus_fnla')
